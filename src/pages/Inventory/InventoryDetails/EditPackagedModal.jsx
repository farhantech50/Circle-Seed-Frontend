...
const EditPackagedModal = ({ open, setOpen, rowData, onSuccess }) => {
  const { updatePackagedInventory, loading } = useInventory();
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await updatePackagedInventory(rowData.id, payload);
    if (res.success) {
  ...
  return (
    <CustomModal
      open={open}
      setOpen={handleClose}
      header="Edit Packaged Inventory"
      width="max-w-md"
    >
...
export default EditPackagedModal;
