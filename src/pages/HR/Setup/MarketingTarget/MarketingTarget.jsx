...
import CreateMarketingTargetModal from "./CreateMarketingTargetModal";
...
const MarketingTarget = () => {
  const { getMarketingTargets, deleteMarketingTarget, loading } = useTarget();
  ...
  const fetchTargets = async () => {
    const res = await getMarketingTargets({
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      const res = await deleteMarketingTarget(id);
  ...
  const columnMapping = {
    ...
    "Target Visits": "targetVisits",
    "Target Follow-ups": "targetFollowUps",
  ...
  const columnAlignment = {
    ...
    Year: "center",
    "Target Leads": "center",
    "Target Visits": "center",
    "Target Follow-ups": "center",
    "Created By": "left",
    Action: "center",
  };
  ...
  return (
    <div className="flex flex-col gap-4 p-4">
      ...
      <DataTableWithoutApiPagination
        ...
        headerConfig={{
          title: "Marketing Targets List",
          searchPlaceholder: "Search Marketing Targets...",
        }}
      />

      <CreateMarketingTargetModal
        open={open}
        setOpen={setOpen}
